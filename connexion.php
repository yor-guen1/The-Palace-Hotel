...
<body>
    <?php
        //pour la condition de reussite de connnexion (en cas diterupption ) ici si linscription reussi
    ...
    if(isset($_SESSION["erreur"]) && $_SESSION["erreur"]==true){
          echo '<script> alert("Pseudo ou Mot de passe faux");</script>';
    ...
    <!--about-->
    <div class="container">
        <h2 class="heading-title  text-center" id="connexion">Connexion</h2>
        <div id="avis" class="avis">
                <form id="formulaire" class="form-inline" method="post" action="LOGIN.php">
                        ...
                        <button id="btn" type="submit" class="btn btn-primary btn-lg">Connecter</button>
                </form>		
        </div>
    </div>
